...
const SkillsRequiredCard = ({ isFreelancer, isActive }) => {
	return (
		<div className="flex flex-wrap justify-between rounded-xl border border-solid border-purple-500 bg-[#492772] bg-opacity-70 sm:py-8 sm:px-4 py-4 px-2 2xl:w-[1200px] m-4">
			<div>
