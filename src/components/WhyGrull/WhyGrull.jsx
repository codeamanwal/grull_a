...
const WhyGrull = () => {
	return (
		<section className="flex flex-col items-center bg-purple-400 rounded-t-3xl py-4">
			<div
			...
			<div className="grid grid-cols-2 sm:grid-cols-4 gap-4">
				...
				<Features
					logo={efficientEscrow}
					title="EFFICIENT ESCROW"
					subtitle="Efficient escrow for efficient transactions so you don&#39;t have to wait for long periods for your own earnings."
				/>

				<Features
					logo={transparency}
					title="TRANSPARENCY"
					subtitle="No more distrust between buyer and seller. With the power of smart contracts, one is bound to maintain honesty."
				/>
